...
ggplot(aes(as.factor(mu), beta_estimate, colour=method)) +
  ...
  theme_bw()
beta_7pt_1rep
ggsave('12_beta_7pt_1rep_fig3a.png', beta_7pt_1rep, path='12_explore_mu_plots/', width = 8, height=6)
...
beta_10pt_3rep <- parallel_res_df %>%
  ...
  theme_bw()
beta_10pt_3rep
ggsave('12_beta_10pt_3rep_fig3b.png', beta_10pt_3rep, path='12_explore_mu_plots/', width = 8, height=6)
...
betapval_7pt_1rep <- parallel_res_df %>%
  ...
  theme_bw() + xlab('mu')
betapval_7pt_1rep
ggsave('12_betapval_7pt_1rep.png', betapval_7pt_1rep, path='12_explore_mu_plots/', width = 8, height=6)
...
betapval_10pt_3rep <- parallel_res_df %>%
  ...
  theme_bw() + xlab('mu')
betapval_10pt_3rep
ggsave('12_betapval_10pt_3rep.png', betapval_10pt_3rep, path='12_explore_mu_plots/', width = 8, height=6)
...
testpval_7pt_1rep <- parallel_res_df %>%
  ...
  theme_bw() + xlab('mu')
testpval_7pt_1rep
ggsave('12_testpval_7pt_1rep_fig3c.png', testpval_7pt_1rep, path='12_explore_mu_plots/', width = 8, height=6)
...
testpval_10pt_3rep <- parallel_res_df %>%
  ...
  theme_bw() + xlab('mu')
testpval_10pt_3rep
ggsave('12_testpval_10pt_3rep_fig3d.png', testpval_10pt_3rep, path='12_explore_mu_plots/', width = 8, height=6)
